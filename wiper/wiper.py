'''
Alexa Custom Skill to control an Wiper
    - Uses the flask-ask library

Usage:
Alexa, tell new wiper to turn on
Alexa, ask new wiper to turn off
...
wiperPin = 18 #pin 11 is connected to the led anode (+ve pin)
GPIO.setmode(GPIO.BOARD)       # Numbers GPIOs by physical location
GPIO.setup(wiperPin, GPIO.OUT)   # Set ledPin's mode as output
GPIO.output(wiperPin, GPIO.LOW) # Set ledPin low to turn off the led
